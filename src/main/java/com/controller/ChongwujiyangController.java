...
public class ChongwujiyangController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		chongwujiyang.setClicknum(chongwujiyang.getClicknum()+1);
		chongwujiyang.setClicktime(new Date());
    ...
    public R autoSort(@RequestParam Map<String, Object> params,ChongwujiyangEntity chongwujiyang, HttpServletRequest request,String pre){
        EntityWrapper<ChongwujiyangEntity> ew = new EntityWrapper<ChongwujiyangEntity>();
