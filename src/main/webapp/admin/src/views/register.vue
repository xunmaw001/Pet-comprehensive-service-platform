  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">宠物综合服务平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   <div class="label">医龄</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yiling" class="input" type="text" placeholder="医龄">
			   </div>
			 </div> -->
			<el-form-item label="医龄" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.yiling" autocomplete="off" placeholder="医龄"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   <div class="label">手机</div>
			   <div class="input-container">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if(`yisheng` == this.tableName && this.ruleForm.yiling&&(!this.$validate.isIntNumer(this.ruleForm.yiling))){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210303/de8253eeb5004568abd86c694b6f64f3.jpg");
		height: 100vh;
