<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宠物分类" prop="chongwufenlei">
          <el-input v-model="ruleForm.chongwufenlei" 
              placeholder="宠物分类" clearable  :readonly="ro.chongwufenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宠物分类" prop="chongwufenlei">
              <el-input v-model="ruleForm.chongwufenlei" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="诊治时间" prop="zhenzhishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.zhenzhishijian" 
                type="datetime"
                placeholder="诊治时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhenzhishijian" label="诊治时间" prop="zhenzhishijian">
              <el-input v-model="ruleForm.zhenzhishijian" 
                placeholder="诊治时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="药方" prop="yaofang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="药方"
                  v-model="ruleForm.yaofang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yaofang" label="药方" prop="yaofang">
                    <span>{{ruleForm.yaofang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.zhenzhishijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chubuzhenduan = true;
          ...
          if(o=='yaofang'){
            this.ruleForm.yaofang = obj[o];
	    this.ro.yaofang = true;
            continue;
          }
          if(o=='zhenzhishijian'){
            this.ruleForm.zhenzhishijian = obj[o];
	    this.ro.zhenzhishijian = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `chongwuzhenliao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chongwuzhenliaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
