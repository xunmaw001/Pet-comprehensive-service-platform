    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="挂号原因" prop="guahaoyuanyin">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.guahaoyuanyin" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.guahaoyuanyin" label="挂号原因" prop="guahaoyuanyin">
                    <span v-html="ruleForm.guahaoyuanyin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.nianling = true;
          ...
          if(o=='guahaoyuanyin'){
            this.ruleForm.guahaoyuanyin = obj[o];
	    this.ro.guahaoyuanyin = true;
            continue;
          }
          if(o=='guahaoshijian'){
	...
	this.ruleForm.guahaoyuanyin = this.ruleForm.guahaoyuanyin.replace(reg,'../../../ssm51k00/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zaixianguahao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zaixianguahaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
