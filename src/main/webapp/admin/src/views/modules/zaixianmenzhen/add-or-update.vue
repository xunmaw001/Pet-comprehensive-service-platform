<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="医生工号" prop="yishenggonghao">
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.yishenggonghao" label="医生工号" prop="yishenggonghao">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医龄" prop="yiling">
          <el-input v-model="ruleForm.yiling" 
              placeholder="医龄" clearable  :readonly="ro.yiling"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医龄" prop="yiling">
              <el-input v-model="ruleForm.yiling" 
                placeholder="医龄" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="主治疾病" prop="zhuzhijibing">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="主治疾病"
                  v-model="ruleForm.zhuzhijibing" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuzhijibing" label="主治疾病" prop="zhuzhijibing">
                    <span>{{ruleForm.zhuzhijibing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='zhuzhijibing'){
            this.ruleForm.zhuzhijibing = obj[o];
	    this.ro.zhuzhijibing = true;
            continue;
          }
          if(o=='keshijieshao'){
    ...
    yishenggonghaoChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              ...
              if(data.data.yiling){
                this.ruleForm.yiling = data.data.yiling
              }
              if(data.data.shouji){
	...
	this.ruleForm.keshijieshao = this.ruleForm.keshijieshao.replace(reg,'../../../ssm51k00/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zaixianmenzhen/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zaixianmenzhenCrossAddOrUpdateFlag = false;
                  this.parent.search();
